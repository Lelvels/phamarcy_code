...
features_data_fp = '../output/shapes_and_features/clean_data/'+str(pcc_point)+"_shapes_and_features_unclean_data.xlsx"
result_fp = "../output/model_result/clean_data/"+str(pcc_point)+"_Ket qua danh gia mo hinh HDAC2_unclean_data.xlsx"
...
def clean_modred_des(train_modred_descriptors, test_mordred_descriptors):
...
def get_train_test_modred_des():
    # read descriptors
    print("[+] Getting modred descriptors for HDAC2: ")
    train_modred_descriptors = process_modred(train_dataset['SMILES'])
    test_mordred_descriptors = process_modred(test_dataset['SMILES'])
    # Clean descriptors
    train_modred_descriptors, test_mordred_descriptors, all_mordred_descriptors = clean_modred_des(train_modred_descriptors, test_mordred_descriptors)
    # Print
